...
function Article() {
    return (
        <article className="master">
            <h2 className="master__title">Поиск мастера</h2>
            <form action="" method="post">
                <input
                    id="master"
                    type="text"
                    className="master__search"
                    placeholder="Найди своего мастера"
                ></input>
                <label for="master" className="master__label">
                    <svg
                        width="16"
                        height="16"
                        viewBox="0 0 16 16"
                ...
                <button
                    className="button button--master"
                    type="submit"
                    value="Записаться"
                >
